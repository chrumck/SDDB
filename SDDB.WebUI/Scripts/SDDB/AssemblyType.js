...
$(document).ready(function () {
    ...
    $("#BtnCreate").click(function () {
        ...
        fillFormForCreateGeneric("EditForm", MagicSuggests, "Create Assembly Type", "MainView");
    });
    ...
    $("#BtnEdit").click(function () {
        ...
        if (CurrIds.length == 0) { showModalNothingSelected(); }
            ...
            fillFormForEditGeneric(CurrIds, "POST", "/AssemblyTypeSrv/GetByIds", GetActive, "EditForm", "Edit Assembly Type", MagicSuggests)
    ...
    $("#EditFormBtnOk").click(function () {
        ...
        if (formIsValid("EditForm", CurrIds.length == 0) && msIsValid(MagicSuggests)) {
            showModalWait();
            submitEditsGeneric("EditForm", MagicSuggests, CurrRecords, "POST", "/AssemblyTypeSrv/Edit")
                .always(hideModalWait)
                .done(function () {
                    refreshMainView();
                    $("#MainView").removeClass("hide");
...
function DeleteRecords() {
    CurrIds = TableMain.cells(".ui-selected", "Id:name").data().toArray();
    deleteRecordsGeneric(CurrIds, "/AssemblyTypeSrv/Delete", refreshMainView);
}

//refresh view after magicsuggest update
function refreshMainView() {
    refreshTblGenWrp(TableMain, "/AssemblyTypeSrv/Get", { getActive: GetActive });
}

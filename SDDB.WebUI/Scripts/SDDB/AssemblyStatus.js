...
$(document).ready(function () {
    ...
    $("#BtnCreate").click(function () {
        IsCreate = true;
        FillFormForCreate("EditForm", MagicSuggests, "Create Assembly Status", "MainView");
    });
    ...
    TableMain = $("#TableMain").DataTable({
        ajax: { url: "/AssemblyStatusSrv/Get?getActive=" + (($("#ChBoxShowDeleted").prop("checked")) ? false : true) },
        columns: [
            { data: "Id", name: "Id" },//0

...
function RefreshTable(table, url, getActive, httpType, projectIds) {
    ...
    $.ajax({
        type: httpType, url: url, timeout: 20000, data: { getActive: getActive, projectIds: projectIds }, dataType: "json",
        beforeSend: function () {

...
$(document).ready(function () {
    ...
    $(MsFilterByProject).on('selectionchange', function (e, m) {
        RefreshTable(TableMain, "/LocationSrv/GetByProjectIds", ($("#ChBoxShowDeleted").prop("checked") ? false : true),
    ...
    TableMain = $("#TableMain").DataTable({
        ajax: {
            url: "/LocationSrv/GetByProjectIds",
            type: "POST",
...
function DeleteRecords() {
    ...
    $.ajax({
        ...
        .always(function () { $("#ModalWait").modal("hide"); })
        .done(function () {
            RefreshTable(TableMain, "/LocationSrv/GetByProjectIds",

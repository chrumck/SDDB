...
$(document).ready(function () {
    ...
    $("#BtnEdit").click(function () {
        ...
        if (CurrIds.length == 0) { showModalNothingSelected(); }
            ...
            fillFormForEditGeneric(CurrIds, "POST", "/PersonActivityTypeSrv/GetByIds", GetActive, "EditForm", "Edit Activity Type", MagicSuggests)
...
function DeleteRecords() {
    CurrIds = TableMain.cells(".ui-selected", "Id:name", { page: "current" }).data().toArray();
    deleteRecordsGeneric(CurrIds, "/PersonActivityTypeSrv/Delete", refreshMainView);
}

//refresh view after magicsuggest update
function refreshMainView() {
    refreshTblGenWrp(TableMain, "/PersonActivityTypeSrv/Get", { getActive: GetActive });
}

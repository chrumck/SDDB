...
$(document).ready(function () {
    ...
    $("#BtnEdit").click(function () {
        ...
        if (CurrIds.length == 0) { showModalNothingSelected(); }
            ...
            fillFormForEditGeneric(CurrIds, "POST", "/ComponentModelSrv/GetByIds", GetActive, "EditForm", "Edit Component Model", MagicSuggests)
...
function refreshMainView() {
    refreshTblGenWrp(TableMain, "/ComponentModelSrv/Get", { getActive: GetActive });
}

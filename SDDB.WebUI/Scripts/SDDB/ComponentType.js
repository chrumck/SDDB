...
$(document).ready(function () {
    ...
    $("#BtnEdit").click(function () {
        ...
        if (CurrIds.length == 0) { showModalNothingSelected(); }
            ...
            fillFormForEditGeneric(CurrIds, "POST", "/ComponentTypeSrv/GetByIds", GetActive, "EditForm", "Edit Component Type", MagicSuggests)
...
function refreshMainView() {
    refreshTblGenWrp(TableMain, "/ComponentTypeSrv/Get", { getActive: GetActive });
}

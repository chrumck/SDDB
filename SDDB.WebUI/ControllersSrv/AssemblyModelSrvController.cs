    ...
    public class AssemblyModelSrvController : BaseSrvCtrl
    {
        ...
        public async Task<ActionResult> Get(bool getActive = true)
        {
            var data = (await assyModelService.GetAsync(getActive).ConfigureAwait(false)).Select(x => {
                ...
                Attr01Type,x.Attr01Desc,Attr02Type,x.Attr02Desc,Attr03Type,x.Attr03Desc,Attr04Type,x.Attr04Desc,
                Attr05Type,x.Attr05Desc,Attr06Type,x.Attr06Desc,Attr07Type,x.Attr07Desc,Attr08Type,x.Attr08Desc,
                Attr09Type,x.Attr09Desc,Attr10Type,x.Attr10Desc
                };
            });

            ViewBag.ServiceName = "AssemblyModelService.GetAsync"; ViewBag.StatusCode = HttpStatusCode.OK;

            return Json(new { data }, JsonRequestBehavior.AllowGet);
        }

        // GET: /AssemblyModelSrv/GetByIds
        [HttpPost]
        [DBSrvAuth("AssemblyModel_View")]
        ...
        public async Task<ActionResult> Lookup(string query = "", bool getActive = true)
        {
            ...
            ViewBag.ServiceName = "AssemblyModelService.LookupAsync"; ViewBag.StatusCode = HttpStatusCode.OK;
        ...
        public async Task<ActionResult> Edit(AssemblyModel[] records)
        {
            ...
            ViewBag.ServiceName = "AssemblyModelService.EditAsync"; ViewBag.StatusCode = serviceResult.StatusCode; 
        ...
        public async Task<ActionResult> Delete(string[] ids)
        {
            ...
            ViewBag.ServiceName = "AssemblyModelService.DeleteAsync"; ViewBag.StatusCode = serviceResult.StatusCode;
            ViewBag.StatusDescription = serviceResult.StatusDescription;

...
namespace SDDB.UnitTests
{
    ...
    public class Tests_PersonLogEntryService
    {
        ...
        public void PersonLogEntryService_LookupAsync_ReturnsAllRecords()
        {
            ...
            var projectPerson1 = new Person { Id = "DummyUserId", FirstName = "Firs1", LastName = "Last1", Initials = "Initials1" };
            ...
            var dbEntry1 = new PersonLogEntry
            {
                ...
                EnteredByPerson = projectPerson1
            };
            var dbEntry2 = new PersonLogEntry
            {
                Id = "dummyEntryId2",
            ...
            var dbEntry3 = new PersonLogEntry
            {
                Id = "dummyEntryId3",
            ...
            //Act
            var returnedPrsLogEntrys = prsLogEntryService.LookupAsync("").Result;
        ...
        public void PersonLogEntryService_LookupAsync_ReturnsMatchingRecords()
        {
            ...
            //Act
            var returnedPrsLogEntrys = prsLogEntryService.LookupAsync("Comments1").Result;
        ...
        public void PersonLogEntryService_LookupAsync_ReturnsNoRecordsIfNotActive()
        {
            ...
            //Act
            var returnedPrsLogEntrys = prsLogEntryService.LookupAsync("DummyComments3").Result;
